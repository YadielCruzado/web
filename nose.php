    	...
    	<div class="panel">
			...
			<div class="backgrounds"> -->
				...
				<div class="item item_1">
					<img src="./otro/images/slider/02.jpg" alt="Slider 01" />
				</div>
                <!-- /item -->
				
				<div class="item item_2">
					<img src="./otro/images/slider/03.jpg" alt="Slider 02" />
				</div> 
                <!-- /item -->				
				<div class="item item_3">
					<img src="./otro/images/slider/01.jpg" alt="Slider 03" />
				</div> -->
                <!-- /item -->
        	...
        	<div class="sidebar_box"><span class="bottom"></span>
                ...
                <div class="content"> 
                	<ul class="sidebar_list">
                    	<li class="first"><a href="#">Best sellers</a></li>
